...
<div class="contenido-pelicula">
	<div class="datos-pelicula">
		...
		<p>Remake de la película homónima de 1995 adaptado a la época
			actual, en donde cuatro adolescentes se introducen en un nueva
			aventura a partir de “Jumanji”, un videojuego que sirve como un
			portal a través del espacio-tiempo. Absorbidos por el mundo de
			Jumanji, este juego no se puede abandonar hasta que acaba la partida</p>
		<br>
		<div class="tabla">
			<div class="fila">
			...
			<div class="fila">
				...
				<div class="celda">Dwayne Johnson, Kevin Hart, Jack Black,
					Karen Gillan</div>
			</div>
		</div>
	</div>
...
<div class="pelicula-video">
	...
	<embed src="http://www.youtube.com/v/6maujJFcuxAfs"
