...
<header>
	<nav class="nav-sec">
		<a href="index.html">Inicio</a>&nbsp;&nbsp;l&nbsp;&nbsp; <a
	...
	<nav class="menu">
		...
		<ul class="menu-principal">
			...
			<li class="menu-item"><a href="peliculas.html?id=estreno">Próximos
					estrenos</a></li>
			<li class="menu-item"><a
				href="http://www.cinestar.com.pe/starcard">Star Card</a></li>
			<li class="menu-item"><a href="cines.html">Nuestros Cines</a></li>
			<li class="menu-item"><a
				href="http://www.cinestar.com.pe/ventas_corporativas">Ventas
					Corporativas</a></li>
			<li class="menu-item"><a
				href="http://www.cinestar.com.pe/promociones">Promociones</a></li>
			<li class="menu-item"><a
				href="http://www.cinestar.com.pe/cinefilo_star">Blog</a></li>
		</ul>
	</nav>
